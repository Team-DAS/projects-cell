...
/**
 * Configuración de RabbitMQ para el servicio de proyectos (PRODUCTOR).
 * Este servicio publica eventos cuando se crean, actualizan o eliminan proyectos.
 */
@Configuration
public class RabbitMQConfig {
    ...
    public TopicExchange projectEventsExchange() {
        return new TopicExchange(projectEventsExchange, true, false);
    }
